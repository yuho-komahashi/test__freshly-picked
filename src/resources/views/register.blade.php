...
<div class="heading">
    <div class="heading__inner">
        <h1 class="heading__inner--title">商品登録</h1>
    </div>
</div>
     ...
     <div class="contents__inner">
        <form class="register-form" action="/products/register" method="post" enctype="multipart/form-data">
            ...
            <div class="register-form__group">
                ...
                <span class="register-form__label--required">必須</span>
                <a href="" ><!--遷移先が入る-->
                    <img class="register-form__img" src="{{ asset('storage/img/banana.png') }}" alt="バナナ">
                </a>
                <input class="register-form__input--image" type="file" name="image" id="image" value="{{ old('image') }}" width="375" height="280">
                <p class="register-form__error">
                    商品画像を登録してください
                </p>
                <p class="register-form__error">
