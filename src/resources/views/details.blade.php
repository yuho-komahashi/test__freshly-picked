    ...
    <form class="detail-form" action="/products/{productId}/update" method="post" enctype="multipart/form-data">
        <div class="detail-form__grid">
            <div class="detail-form__image">
                <img class="detail-form__img" src="{{ asset('storage/img/peach.png') }}" alt="ピーチ">
                <input class="detail-form__input--image" type="file" name="image" value="{{ old('image') }}" width="375" height="280">
